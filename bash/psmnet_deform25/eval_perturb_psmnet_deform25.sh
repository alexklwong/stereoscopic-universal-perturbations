...
SUPS_DIRPATH=pretrained_perturbations/psmnet_deform25/tile64_norm002
SUPS_FILENAME=sups_psmnet_deform25_tile64_norm002.pth
...
--stereo_model_restore_path pretrained_stereo_models/psmnet_deform25/pretrained_KITTI2015.tar \
--output_dirpath $SUPS_DIRPATH/evaluation_results/psmnet_deform25/kitti2015 \
--save_outputs \
--device gpu
