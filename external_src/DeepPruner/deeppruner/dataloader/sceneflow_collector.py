...
def dataloader(filepath_monkaa, filepath_flying, filepath_driving):
    ...
    try:
        monkaa_path = os.path.join(filepath_monkaa, 'monkaa_frames_finalpass')
    ...
    try:
        flying_path = os.path.join(filepath_flying, 'frames_finalpass')
        flying_disp = os.path.join(filepath_flying, 'frames_disparity')
    ...
    try:
        driving_dir = os.path.join(filepath_driving, 'driving_frames_finalpass/')
