...
parser.add_argument('--num_deform_layers',
    type=int, default=0, help='Number of deformable convolution layers [0, 25]')
...
TrainImgLoader = torch.utils.data.DataLoader(
         ...
         batch_size=16, shuffle=True, num_workers=2, drop_last=False)
...
model = DeepPruner(num_deform_layers=args.num_deform_layers)
